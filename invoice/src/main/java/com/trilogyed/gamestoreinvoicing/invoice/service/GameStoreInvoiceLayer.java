...
@Component
@Configuration
public class GameStoreInvoiceLayer {
    ...
    @Autowired
    public GameStoreInvoiceLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo, GameRepository gameRepo, ConsoleRepository consoleRepo, TShirtRepository tShirtRepo)  {
    ...
    public GameStoreInvoiceLayer(GameRepository gameRepository, ConsoleRepository consoleRepository, TShirtRepository tShirtRepository, InvoiceRepository invoiceRepository, TaxRepository taxRepository, ProcessingFeeRepository processingFeeRepository) {
