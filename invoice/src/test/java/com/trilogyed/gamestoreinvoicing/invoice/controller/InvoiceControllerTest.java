package com.trilogyed.gamestoreinvoicing.invoice.controller;

import com.trilogyed.gamestoreinvoicing.invoice.service.GameStoreInvoiceLayer;
...
public class InvoiceControllerTest {
    ...
    @MockBean
    private GameStoreInvoiceLayer invoiceLayer;
    ...
    public void shouldAddPurchase() throws Exception{
        ...
        when(invoiceLayer.createInvoice(inInvoice)).thenReturn(savedInvoice);
    ...
    public void shouldFindInvoice() throws Exception{
        ...
        //Mock call to service layer...
        when(invoiceLayer.getInvoice(22)).thenReturn(savedInvoice);
        ...
        //Mock call to service layer...
        when(invoiceLayer.getInvoice(-1)).thenReturn(null);
    ...
    public void shouldFindAllInvoices() throws Exception{
        ...
        //Mock call to service layer...
        when(invoiceLayer.getAllInvoices()).thenReturn(foundAllInvoices);
        ...
        //Mock call to service layer...
        when(invoiceLayer.getAllInvoices()).thenReturn(null);
    ...
    public void shouldFindInvoicesByCustomerName() throws Exception{
        ...
        //Mock call to service layer...
        when(invoiceLayer.getInvoicesByCustomerName("Sandy Beach")).thenReturn(foundAllInvoices);
        ...
        //Mock call to service layer...
        when(invoiceLayer.getInvoicesByCustomerName("no customer")).thenReturn(null);
    ...
    public void shouldFailCreateUnvoiceWithBadData() throws Exception{
        ...
        when(this.invoiceLayer.createInvoice(inInvoiceMV)).thenReturn(null);
